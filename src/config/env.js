...
const DEFAULTS = {
  ...
  SIMULATED_MONITOR_LOG_PATH: "logs/polypulse-simulated-monitor.log",
  PRIVATE_KEY: "",
  FUNDER_ADDRESS: "",
  SIGNATURE_TYPE: "",
  CHAIN_ID: "137",
  ...
  PULSE_AI_EVIDENCE_RESEARCH: "true",
  PULSE_EVIDENCE_RESEARCH_TIMEOUT_MS: "60000",
  PULSE_EVIDENCE_RESEARCH_MAX_SEARCHES: "5",
...
export async function loadEnvConfig(options = {}) {
  ...
  return {
    ...
    simulatedMonitorLogPath: path.resolve(values.SIMULATED_MONITOR_LOG_PATH || DEFAULTS.SIMULATED_MONITOR_LOG_PATH),
